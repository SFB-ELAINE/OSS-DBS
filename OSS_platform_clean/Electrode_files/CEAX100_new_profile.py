...
#encap_tip_rad_section=(0.06+encap_thickness)-(0.035/0.04)*encap_thickness
...
lead_body = geompy.MakeCylinderRH(0.2, 27.5)
#cone parameters should be parametrizable
lead_Cone_1 = geompy.MakeConeR1R2H(Contact_base_radius, 0.2, 0.1333+contact_shift)
geompy.TranslateDXDYDZ(lead_Cone_1, 0, 0, -0.1333-contact_shift)

#lead_Cone_2 = geompy.MakeConeR1R2H(0.075, 0.15, 0.2)
#geompy.TranslateDXDYDZ(lead_Cone_2, 0, 0, -0.3333)
#0.04 can be changed here later
lead_Cone_3 = geompy.MakeConeR1R2H(R_cut, Contact_base_radius, tip_length)    #tip length should change together with the smaller diameter
geompy.TranslateDXDYDZ(lead_Cone_3, 0, 0, -0.5033+0.2+0.17-tip_length-contact_shift)

geompy.addToStudy( lead_Cone_3, 'lead_Cone_no_fillet' )

lead_Cone_3 = geompy.MakeFillet(lead_Cone_3, fillet_radius, geompy.ShapeType["EDGE"], [9])
#lead_Sphere_tip = geompy.MakeSphereR("tip_radius")

encap_body = geompy.MakeCylinderRH("encap_body_radial", 27.5)
encap_Cone_1 = geompy.MakeConeR1R2H("encap_cone1_radial", "encap_body_radial", 0.1333+contact_shift)
geompy.TranslateDXDYDZ(encap_Cone_1, 0, 0, -0.1333-contact_shift)
...
encap_Cone_3 = geompy.MakeConeR1R2H(encap_cone3_radial, Contact_base_radius+encap_thickness, tip_length+encap_thickness)
geompy.TranslateDXDYDZ(encap_Cone_3, 0, 0, -0.5033+0.2-encap_thickness+0.17-tip_length-contact_shift)
#encap_tip_radius=encap_thickness+0.04

geompy.addToStudy( encap_Cone_3, 'encap_Cone_no_fillet' )
encap_Cone_3= geompy.MakeFillet(encap_Cone_3, fillet_radius, geompy.ShapeType["EDGE"], [9])
...
encap_cone_object = geompy.MakeFuseList([encap_Cone_1, encap_Cone_3], True, True)
lead_cone_all = geompy.MakeFuseList([lead_Cone_1, lead_Cone_3], True, True)
encap_cone_layer = geompy.MakeCutList(encap_cone_object, [lead_cone_all], True)

dbs_lead = geompy.MakeFuseList([lead_body, lead_Cone_1, lead_Cone_3], True, True)
...
geompy.addToStudy( lead_Cone_3, 'lead_Cone_3' )
geompy.addToStudy( encap_Cone_3, 'encap_Cone_3' )

geompy.addToStudy( dbs_lead, 'dbs_lead' )
geompy.addToStudy( encap_body_full, 'encap_body_full' )
geompy.addToStudy( encap_complete_body_layer, 'encap_complete_body_layer' )
...
geompy.TranslateDXDYDZ(lead_body, 0, 0, shift_new)
geompy.TranslateDXDYDZ(lead_Cone_1, 0, 0, shift_new)
listFreeFacesIDs = geompy.GetFreeFacesIDs(lead_Cone_1)
listFreeFacesIDs = geompy.GetFreeFacesIDs(lead_Cone_1)
[Contact_old,geomObj_12,geomObj_13] = geompy.SubShapes(lead_Cone_1, [3, 10, 12])
#geompy.TranslateDXDYDZ(lead_Cone_2, 0, 0, shift_new)
geompy.TranslateDXDYDZ(lead_Cone_3, 0, 0, shift_new)
listFreeFacesIDs = geompy.GetFreeFacesIDs(lead_Cone_3)
listFreeFacesIDs = geompy.GetFreeFacesIDs(lead_Cone_3)
#geompy.TranslateDXDYDZ(lead_Sphere_tip, 0, 0, shift_new)
#listFreeFacesIDs = geompy.GetFreeFacesIDs(lead_Sphere_tip)
#listFreeFacesIDs = geompy.GetFreeFacesIDs(lead_Sphere_tip)
#[sphere_tip_surface] = geompy.SubShapes(lead_Sphere_tip, [3])
geompy.TranslateDXDYDZ(encap_body, 0, 0, shift_new)
geompy.TranslateDXDYDZ(encap_Cone_1, 0, 0, shift_new)
#geompy.TranslateDXDYDZ(encap_Cone_2, 0, 0, shift_new)
geompy.TranslateDXDYDZ(encap_Cone_3, 0, 0, shift_new)
#geompy.TranslateDXDYDZ(encap_Sphere_tip, 0, 0, shift_new)
geompy.TranslateDXDYDZ(encap_cone_object, 0, 0, shift_new)
geompy.TranslateDXDYDZ(lead_cone_all, 0, 0, shift_new)
geompy.TranslateDXDYDZ(encap_cone_layer, 0, 0, shift_new)
geompy.TranslateDXDYDZ(encap_complete_body_layer, 0, 0, shift_new)
geompy.TranslateDXDYDZ(dbs_lead, 0, 0, shift_new)
geompy.TranslateDXDYDZ(Sphere_ROI, 0, 0, shift_new)
...
#Contact_1_solid = geompy.MakeFuseList([lead_Cone_3], True, True)
...
[Free_face_1_7,Free_face_1_8, Free_face_1_9] = geompy.SubShapes(lead_Cone_3, [3, 10,17])
Contact_1 = geompy.MakeFuseList([Free_face_1_7, Free_face_1_8, Free_face_1_9], True, True)
...
#New contact
Vertex_1 = geompy.MakeVertex(0, 0, "ground_start")		#can be modified
Vertex_2 = geompy.MakeVertex(0, 0, 7)
Vector_1 = geompy.MakeVector(Vertex_1, Vertex_2)
Cylinder_1 = geompy.MakeCylinder(Vertex_1, Vector_1, 0.2, "ground_length")
Cut_1 = geompy.MakeCutList(encap_outer_ROI, [Cylinder_1], True)
geompy.addToStudy( Cut_1, 'Cut_1' )
listFreeFacesIDs = geompy.GetFreeFacesIDs(Cut_1)
try:
    [Free_face_1_1,Free_face_1_2,Free_face_1_3,Free_face_1_4,Contact_2,Free_face_1_6] = geompy.SubShapes(Cut_1, [3, 10, 15, 20, 25, 30])  #when some space left from the bottom?
except:
    [Free_face_1_1,Free_face_1_2,Free_face_1_3,Free_face_1_4,Contact_2] = geompy.SubShapes(Cut_1, [3, 10, 15, 20, 25])
...
#geompy.UnionIDs(Tip_point, [87])  #hamster
geompy.UnionIDs(Tip_point, [83])
