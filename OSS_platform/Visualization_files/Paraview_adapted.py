...
cSF_Subdomains_adapted = PVDReader(FileName='Field_solutions/parallel_Subdomains.pvd')
...
renderView1.ResetCamera()
SaveScreenshot('Images/Adapted_mesh.png', magnification=1, quality=100, view=renderView1)
