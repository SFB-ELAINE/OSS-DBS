...
for connection in list_of_connections:
    ...
    connection_csv = CSVReader(FileName=['Field_solutions/Activation/Neuron_model_results_'+connection+'.csv'])
...
renderView1.ResetCamera()
SaveScreenshot('Images/Axon_activation.png', magnification=1, quality=100, view=renderView1)
