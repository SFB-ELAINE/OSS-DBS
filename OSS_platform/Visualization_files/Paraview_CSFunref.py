...
cSF_Subdomains_unrefpvd = PVDReader(FileName='CSF_ref/CSF_Subdomains_unref.pvd')
...
renderView1.ResetCamera()
SaveScreenshot('Images/CSF_unref.png', magnification=1, quality=100, view=renderView1)
