...
Vertex_1_corr = geompy.MakeVertex(0, 0, 0.1833)
Cylinder_1 = geompy.MakeCylinderRH(0.12057, 0.2)
Cylinder_2 = geompy.MakeCylinder(Vertex_1, OZ, 0.2, 27.5)

Cone_1 = geompy.MakeConeR1R2H(0.12057, 0.2, 0.1933)
DBS_lead = geompy.MakeFuseList([Cylinder_1, Cylinder_2,Cone_1], True, True)
...
Cylinder_4 = geompy.MakeCylinder(Vertex_1_corr, OZ, 0.2+encap_thickness, 27.6)

Cone_2 = geompy.MakeCone(Vertex_2, OZ,0.12057+encap_thickness, 0.2+encap_thickness, 0.1933+encap_thickness)
fuse_encap = geompy.MakeFuseList([Cylinder_3, Cylinder_4,Cone_2], True, True)

#fuse_encap = geompy.MakeFuseList([Cylinder_3, Cylinder_4], True, True)
...
#[Free_face_1_1,Free_face_1_2,Free_face_1_3,Free_face_1_4,Contact_2,Free_face_1_5,Free_face_1_6] = geompy.SubShapes(Cut_1, [3, 10, 15, 17, 22, 27,32])  #when some space left from the bottom?
