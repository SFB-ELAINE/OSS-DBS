...
geompy.TranslateDXDYDZ(Contact_1, 0, 0, 0.45)
...
Contact_5 = geompy.MakeTranslation(Contact_1, 0, 0, 8)
Contact_6 = geompy.MakeTranslation(Contact_1, 0, 0, 10)
Contact_7 = geompy.MakeTranslation(Contact_1, 0, 0, 12)
Contact_8 = geompy.MakeTranslation(Contact_1, 0, 0, 14)
...
geompy.TranslateDXDYDZ(CV1, 0, 0, 1.1)
CV2 = geompy.MakeTranslation(CV1, 0, 0, 2)
CV3 = geompy.MakeTranslation(CV1, 0, 0, 4)
CV4 = geompy.MakeTranslation(CV1, 0, 0, 6)
CV5 = geompy.MakeTranslation(CV1, 0, 0, 8)
CV6 = geompy.MakeTranslation(CV1, 0, 0, 10)
CV7 = geompy.MakeTranslation(CV1, 0, 0, 12)
CV8 = geompy.MakeTranslation(CV1, 0, 0, 14)
##################################################################################################################
...
NETGEN_3D_Parameters_5.SetFineness( 0 )
