...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeWidget_Project_Browser.header().setVisible(True)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 974, 860))
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_Neuron_Model_Ready.setIcon(icon8)
        ...
        self.pushButton_Init_Neuron_Model_Ready.setIcon(icon8)
        ...
        self.pushButton_Init_Mesh_Ready.setIcon(icon8)
        ...
        self.pushButton_CSF_Mesh_Ready.setIcon(icon8)
        ...
        self.pushButton_Voxel_orr_MRI.setIcon(icon8)
        ...
        self.pushButton_Parallel_Computing_Interrupted.setIcon(icon8)
        ...
        self.pushButton_Adapted_Mesh_Ready.setIcon(icon8)
        ...
        self.pushButton_Signl_Generation_Ready.setIcon(icon8)
        ...
        self.pushButton_IFFT_Ready.setIcon(icon8)
        ...
        self.pushButton_Voxel_orr_DTI.setIcon(icon8)
        ...
        self.pushButton_Parallel_Computing_Ready.setIcon(icon8)
        ...
        self.gridLayout_7.addLayout(self.gridLayout_18, 0, 0, 1, 1)
        ...
        self.toolBox.setMinimumSize(QtCore.QSize(0, 850))
        self.toolBox.setObjectName("toolBox")
        self.page_9 = QtWidgets.QWidget()
        self.page_9.setGeometry(QtCore.QRect(0, 0, 974, 658))
        self.page_9.setObjectName("page_9")
        self.gridLayout_44 = QtWidgets.QGridLayout(self.page_9)
        ...
        self.pushButton_MRI_Data_Name.setIcon(icon8)
        ...
        self.pushButton_MRI_mm.setIcon(icon8)
        ...
        self.pushButton_DTI_Data_Name.setIcon(icon8)
        ...
        self.pushButton_DTI_mm.setIcon(icon8)
        ...
        self.pushButton_CSF_index.setIcon(icon8)
        ...
        self.pushButton_WM_Index.setIcon(icon8)
        ...
        self.pushButton_WM_Index_2.setIcon(icon8)
        ...
        self.pushButton_Default_Material.setIcon(icon8)
        ...
        self.pushButton_Implantation_Coordinate_X.setIcon(icon8)
        ...
        self.pushButton_Electrode_Type.setIcon(icon8)
        ...
        self.pushButton_Implantation_Coordinate_Y.setIcon(icon8)
        ...
        self.pushButton_Implantation_Coordinate_Z.setIcon(icon8)
        ...
        self.pushButton_2nd_Point_On_Lead_X.setIcon(icon8)
        ...
        self.pushButton_2nd_Point_On_Lead_Y.setIcon(icon8)
        ...
        self.pushButton_2nd_Point_On_Lead_Z.setIcon(icon8)
        ...
        self.pushButton_2nd_Point_On_Lead_Z_2.setIcon(icon8)
        ...
        self.gridLayout_14.addLayout(self.gridLayout_35, 2, 0, 1, 1)
        self.gridLayout_36.addWidget(self.groupBox_3, 1, 0, 1, 1)
        ...
        self.pushButton_Dimensions_From_MRI.setIcon(icon8)
        ...
        self.pushButton_X_Length = QtWidgets.QPushButton(self.widget_Approximating_Dimensions_3)
        self.pushButton_X_Length.setText("")
        self.pushButton_X_Length.setIcon(icon8)
        ...
        self.verticalLayout.addWidget(self.pushButton_X_Length)
        ...
        self.pushButton_Approx_Geometry_Center = QtWidgets.QPushButton(self.widget_Approx_Geometry_Center_3)
        self.pushButton_Approx_Geometry_Center.setText("")
        self.pushButton_Approx_Geometry_Center.setIcon(icon8)
        ...
        self.verticalLayout_2.addWidget(self.pushButton_Approx_Geometry_Center)
        self.gridLayout_19.addWidget(self.widget_Approx_Geometry_Center_3, 5, 2, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.label_Approx_Geom_Centered_On_MRI, 4, 0, 1, 1)
        ...
        self.pushButton_Brain_Shape.setIcon(icon8)
        ...
        self.gridLayout_19.addWidget(self.widget_Approx_Geometry_Center, 5, 0, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.checkBox_Approx_Geom_Centered_On_MRI, 4, 1, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.widget_Approx_Geometry_Center_2, 5, 1, 1, 1)
        ...
        self.pushButton_Approx_Geometry_Center_2.setIcon(icon8)
        ...
        self.gridLayout_19.addWidget(self.pushButton_Approx_Geometry_Center_2, 4, 2, 1, 1)
        ...
        self.gridLayout_36.addItem(spacerItem7, 0, 1, 1, 1)
        spacerItem8 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_36.addItem(spacerItem8, 2, 0, 1, 1)
        self.toolBox.addItem(self.page_4, "")
        self.page_5 = QtWidgets.QWidget()
        self.page_5.setGeometry(QtCore.QRect(0, 0, 974, 658))
        self.page_5.setObjectName("page_5")
        self.gridLayout_37 = QtWidgets.QGridLayout(self.page_5)
        self.gridLayout_37.setObjectName("gridLayout_37")
        spacerItem9 = QtWidgets.QSpacerItem(923, 17, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_37.addItem(spacerItem9, 0, 1, 1, 1)
        ...
        self.pushButton_Encapsulation_Thickness.setIcon(icon8)
        ...
        self.pushButton_CPE_Active.setIcon(icon8)
        ...
        self.pushButton_Encapsulation_Conductivity.setIcon(icon8)
        ...
        self.pushButton_Conductivity_Scaling.setIcon(icon8)
        ...
        self.pushButton_Encapsulation_Scaling.setIcon(icon8)
        ...
        self.gridLayout_37.addItem(spacerItem10, 1, 1, 1, 1)
        self.toolBox.addItem(self.page_5, "")
        self.page_6 = QtWidgets.QWidget()
        self.page_6.setGeometry(QtCore.QRect(0, 0, 974, 658))
        self.page_6.setObjectName("page_6")
        self.gridLayout_38 = QtWidgets.QGridLayout(self.page_6)
        self.gridLayout_38.setObjectName("gridLayout_38")
        spacerItem11 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_38.addItem(spacerItem11, 0, 1, 1, 1)
        ...
        self.pushButton_Neuron_Model_Array_Prepared_2.setIcon(icon8)
        ...
        self.label_Diam_Fib_2.setStyleSheet("QLabel{\n"
"padding-top: 2.5px;\n"
"padding-bottom: 5px;\n"
"}")
        ...
        self.label_V_Init_2.setStyleSheet("QLabel{\n"
"padding-top: 5px;\n"
"padding-bottom: 5px;\n"
"}")
        ...
        self.label_Pattern_Model_Name_2.setStyleSheet("QLabel{\n"
"padding-top: 5px;\n"
...
"}")
        ...
        self.label_N_Ranvier_2.setStyleSheet("QLabel{\n"
"padding-top: 2.5px;\n"
"padding-bottom: 2.5px;\n"
"}")
        ...
        self.pushButton_Diam_Fib_2.setIcon(icon8)
        ...
        self.pushButton_Axon_Model_Type.setIcon(icon8)
        ...
        self.pushButton_Pattern_Model_Name_2.setIcon(icon8)
        ...
        self.pushButton_N_Ranvier_2.setIcon(icon8)
        ...
        self.pushButton_V_Init_2.setIcon(icon8)
        ...
        self.pushButton_Name_Prepared_Neuron_Array_2.setIcon(icon8)
        ...
        self.page_7.setGeometry(QtCore.QRect(0, 0, 974, 658))
        ...
        self.gridLayout_25.addWidget(self.label_3, 5, 2, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.label_T, 4, 0, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.groupBoxComputationalParameters)
        font = QtGui.QFont()
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.gridLayout_25.addWidget(self.label_2, 3, 2, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.label_Frequency, 3, 0, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.label_T_Step, 5, 0, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.label_Phi, 6, 0, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.label_Amplitude_Scale, 7, 0, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.pushButton_Frequency, 3, 3, 1, 1)
        ...
        self.pushButton_Signal_Type.setIcon(icon8)
        ...
        self.gridLayout_25.addWidget(self.doubleSpinBox_T, 4, 1, 1, 1)
        self.label = QtWidgets.QLabel(self.groupBoxComputationalParameters)
        font = QtGui.QFont()
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.gridLayout_25.addWidget(self.label, 4, 2, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.doubleSpinBox_T_Step, 5, 1, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.doubleSpinBox_Signal_Shift, 6, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.groupBoxComputationalParameters)
        font = QtGui.QFont()
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.gridLayout_25.addWidget(self.label_4, 6, 2, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.doubleSpinBox_Amplitude_Scale, 7, 1, 1, 1)
        self.pushButton_T = QtWidgets.QPushButton(self.groupBoxComputationalParameters)
        self.pushButton_T.setText("")
        self.pushButton_T.setIcon(icon8)
        ...
        self.gridLayout_25.addWidget(self.pushButton_Phi, 6, 3, 1, 1)
        ...
        self.pushButton_Amplitude_Scale.setIcon(icon8)
        ...
        self.gridLayout_25.addWidget(self.pushButton_Amplitude_Scale, 7, 3, 1, 1)
        self.label_Phi_Vector = QtWidgets.QLabel(self.groupBoxComputationalParameters)
        font = QtGui.QFont()
        self.label_Phi_Vector.setFont(font)
        self.label_Phi_Vector.setObjectName("label_Phi_Vector")
        self.gridLayout_25.addWidget(self.label_Phi_Vector, 2, 0, 1, 1)
        self.lineEdit_Phi_Vector = QtWidgets.QLineEdit(self.groupBoxComputationalParameters)
        font = QtGui.QFont()
        self.lineEdit_Phi_Vector.setFont(font)
        self.lineEdit_Phi_Vector.setObjectName("lineEdit_Phi_Vector")
        self.gridLayout_25.addWidget(self.lineEdit_Phi_Vector, 2, 1, 1, 1)
        self.pushButton_Phi_Vector = QtWidgets.QPushButton(self.groupBoxComputationalParameters)
        self.pushButton_Phi_Vector.setText("")
        self.pushButton_Phi_Vector.setIcon(icon8)
        ...
        self.gridLayout_25.addWidget(self.pushButton_Phi_Vector, 2, 3, 1, 1)
        self.label_18 = QtWidgets.QLabel(self.groupBoxComputationalParameters)
        self.label_18.setObjectName("label_18")
        self.gridLayout_25.addWidget(self.label_18, 1, 0, 1, 1)
        self.checkBox_Current_Control = QtWidgets.QCheckBox(self.groupBoxComputationalParameters)
        font = QtGui.QFont()
        ...
        self.gridLayout_25.addWidget(self.checkBox_Current_Control, 1, 1, 1, 1)
        self.pushButton_Current_Control = QtWidgets.QPushButton(self.groupBoxComputationalParameters)
        self.pushButton_Current_Control.setText("")
        self.pushButton_Current_Control.setIcon(icon8)
        ...
        self.gridLayout_25.addWidget(self.pushButton_Current_Control, 1, 3, 1, 1)
        ...
        self.gridLayout_39.addItem(spacerItem13, 0, 1, 1, 1)
        spacerItem14 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_39.addItem(spacerItem14, 1, 0, 1, 1)
        self.toolBox.addItem(self.page_7, "")
        self.page_8 = QtWidgets.QWidget()
        self.page_8.setGeometry(QtCore.QRect(0, 0, 974, 658))
        self.page_8.setObjectName("page_8")
        self.gridLayout_40 = QtWidgets.QGridLayout(self.page_8)
        self.gridLayout_40.setObjectName("gridLayout_40")
        spacerItem15 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_40.addItem(spacerItem15, 0, 2, 1, 1)
        ...
        self.pushButton_Truncation_Parameter_2.setIcon(icon8)
        ...
        self.pushButton_Truncation_Parameter.setIcon(icon8)
        ...
        self.pushButton_Truncate_The_Obtained_Full_Solution.setIcon(icon8)
        ...
        font = QtGui.QFont()
        self.checkBox_Show_Paraview_Screenshots.setFont(font)
        self.checkBox_Show_Paraview_Screenshots.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.checkBox_Show_Paraview_Screenshots.setText("")
        self.checkBox_Show_Paraview_Screenshots.setObjectName("checkBox_Show_Paraview_Screenshots")
        self.gridLayout_33.addWidget(self.checkBox_Show_Paraview_Screenshots, 2, 1, 1, 1)
        self.pushButton_Show_Paraview_Screenshots = QtWidgets.QPushButton(self.groupBoxXXX)
        self.pushButton_Show_Paraview_Screenshots.setText("")
        self.pushButton_Show_Paraview_Screenshots.setIcon(icon8)
        self.pushButton_Show_Paraview_Screenshots.setIconSize(QtCore.QSize(24, 24))
        self.pushButton_Show_Paraview_Screenshots.setFlat(True)
        self.pushButton_Show_Paraview_Screenshots.setObjectName("pushButton_Show_Paraview_Screenshots")
        self.gridLayout_33.addWidget(self.pushButton_Show_Paraview_Screenshots, 2, 3, 1, 1)
        spacerItem16 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_33.addItem(spacerItem16, 2, 2, 1, 1)
        ...
        self.pushButton_Full_Field_IFFT.setIcon(icon8)
        ...
        self.gridLayout_26.addWidget(self.pushButton_Full_Field_IFFT, 6, 3, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.spinBox_Number_Of_Processors, 3, 1, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.label_Number_Of_Processors, 3, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.label_Skip_Mesh_Refinement, 5, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.checkBox_Skip_Mesh_Refinement, 5, 1, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.checkBox_FEniCS_MPI, 4, 1, 1, 1)
        self.label_20 = QtWidgets.QLabel(self.groupBoxXXX)
        self.label_20.setObjectName("label_20")
        self.gridLayout_26.addWidget(self.label_20, 4, 0, 1, 1)
        ...
        self.pushButton_Skip_Mesh_Refinement_2.setIcon(icon8)
        ...
        self.gridLayout_26.addWidget(self.pushButton_Skip_Mesh_Refinement_2, 5, 3, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.spinBox_El_Order, 2, 1, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.checkBox_Full_Field_IFFT, 6, 1, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.label_Laplace_Transformation, 1, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.label_Full_Field_IFFT, 6, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.label_El_Order, 2, 0, 1, 1)
        ...
        self.comboBox_Laplace_Formulation.addItem("")
        self.gridLayout_26.addWidget(self.comboBox_Laplace_Formulation, 1, 1, 1, 1)
        ...
        self.pushButton_Laplace_Formulation_2.setIcon(icon8)
        ...
        self.gridLayout_26.addWidget(self.pushButton_Laplace_Formulation_2, 1, 3, 1, 1)
        spacerItem17 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_26.addItem(spacerItem17, 3, 4, 1, 1)
        self.label_5 = QtWidgets.QLabel(self.groupBoxXXX)
        self.label_5.setObjectName("label_5")
        self.gridLayout_26.addWidget(self.label_5, 0, 0, 1, 1)
        self.comboBox_Solver_Type = QtWidgets.QComboBox(self.groupBoxXXX)
        self.comboBox_Solver_Type.setObjectName("comboBox_Solver_Type")
        self.comboBox_Solver_Type.addItem("")
        self.comboBox_Solver_Type.addItem("")
        self.comboBox_Solver_Type.addItem("")
        self.comboBox_Solver_Type.addItem("")
        self.gridLayout_26.addWidget(self.comboBox_Solver_Type, 0, 1, 1, 1)
        self.pushButton_Solver_Type = QtWidgets.QPushButton(self.groupBoxXXX)
        self.pushButton_Solver_Type.setText("")
        self.pushButton_Solver_Type.setIcon(icon8)
        ...
        self.gridLayout_26.addWidget(self.pushButton_Solver_Type, 0, 3, 1, 1)
        self.pushButton_Y_Length_2 = QtWidgets.QPushButton(self.groupBoxXXX)
        self.pushButton_Y_Length_2.setText("")
        self.pushButton_Y_Length_2.setIcon(icon8)
        ...
        self.gridLayout_26.addWidget(self.pushButton_Y_Length_2, 4, 3, 1, 1)
        self.pushButton_El_Order_2 = QtWidgets.QPushButton(self.groupBoxXXX)
        self.pushButton_El_Order_2.setText("")
        self.pushButton_El_Order_2.setIcon(icon8)
        ...
        self.gridLayout_26.addWidget(self.pushButton_El_Order_2, 2, 3, 1, 1)
        ...
        self.pushButton_Number_Of_Processors_2.setIcon(icon8)
        ...
        self.gridLayout_26.addWidget(self.pushButton_Number_Of_Processors_2, 3, 3, 1, 1)
        ...
        self.pushButton_Sprectrum_Truncation_Method.setIcon(icon8)
        ...
        self.gridLayout_27.addItem(spacerItem18, 0, 2, 1, 1)
        ...
        self.gridLayout_40.addItem(spacerItem19, 1, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 960, 1065))
        ...
        self.gridLayout_13.addLayout(self.gridLayout_Images, 0, 0, 1, 1)
        ...
        self.gridLayout_13.addLayout(self.gridLayout_47, 5, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.label_Image_Adapted_Mesh, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.pushButton_Adapted_Mesh, 1, 0, 1, 1)
        self.gridLayout_13.addLayout(self.gridLayout_5, 3, 0, 1, 1)
        ...
        self.gridLayout_45.addWidget(self.label_Image_CSF_Full_Refinement, 0, 0, 1, 1)
        ...
        self.gridLayout_45.addWidget(self.pushButton_CSF_Full_Refinement, 1, 0, 1, 1)
        self.gridLayout_13.addLayout(self.gridLayout_45, 2, 0, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.label_Image_Signal_Recovered, 0, 0, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.pushButton_Signal_Recovered, 1, 0, 1, 1)
        ...
        self.gridLayout_46.addWidget(self.label_Image_Axon_Activation, 0, 0, 1, 1)
        ...
        self.gridLayout_46.addWidget(self.pushButton_Axon_Activation, 1, 0, 1, 1)
        self.gridLayout_13.addLayout(self.gridLayout_46, 6, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "OSS-DBS v0.3"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_9), _translate("MainWindow", "MRI and DTI Data"))
        ...
        self.comboBox_Electrode_Type.setItemText(1, _translate("MainWindow", "QM_blunt"))
        self.comboBox_Electrode_Type.setItemText(2, _translate("MainWindow", "QM_spherical_rounding"))
        self.comboBox_Electrode_Type.setItemText(3, _translate("MainWindow", "Medtronic3387"))
        self.comboBox_Electrode_Type.setItemText(4, _translate("MainWindow", "Medtronic3389"))
        self.comboBox_Electrode_Type.setItemText(5, _translate("MainWindow", "Medtronic3391"))
        self.comboBox_Electrode_Type.setItemText(6, _translate("MainWindow", "St_Jude6142"))
        self.comboBox_Electrode_Type.setItemText(7, _translate("MainWindow", "St_Jude6148"))
        self.comboBox_Electrode_Type.setItemText(8, _translate("MainWindow", "St_Jude6173"))
        self.comboBox_Electrode_Type.setItemText(9, _translate("MainWindow", "St_Jude6180"))
        self.comboBox_Electrode_Type.setItemText(10, _translate("MainWindow", "Boston_Scientific_Vercise"))
        self.comboBox_Electrode_Type.setItemText(11, _translate("MainWindow", "Boston_Scientific_Vercise_Cartesia"))
        self.comboBox_Electrode_Type.setItemText(12, _translate("MainWindow", "PINS_L301"))
        self.comboBox_Electrode_Type.setItemText(13, _translate("MainWindow", "PINS_L302"))
        self.comboBox_Electrode_Type.setItemText(14, _translate("MainWindow", "PINS_L303"))
        ...
        self.pushButton_X_Length.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Provide dimensions (lengths in mm) of the approximating ellipsoid as [x,y,z]. For example, [10.0,12.0,11.0].</span></p></body></html>"))
        self.pushButton_Approx_Geometry_Center.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Provide coordinates of the center point of the approximating ellipsoid as [x,y,z]. For example, [10.0,-0.2,44.6].</span></p><p><span style=\" font-size:14pt; font-weight:600;\">Important</span><span style=\" font-size:14pt;\">: The coordinates should be given in the MRI data space.</span></p></body></html>"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_4), _translate("MainWindow", "Geometries"))
        ...
        self.pushButton_Phi_Vector.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Set up voltage/current on the electrode contacts. If contact is not active, put None, then it will be treated as a floating conductor. Make sure that number of entries corresponds to the number of contacts on the chosen electrode. Value 0.0 always refers to the ground, not 0.0 A!</span></p><p><span style=\" font-size:14pt; font-weight:600;\">Important</span><span style=\" font-size:14pt;\">: If you change position of the ground or non-active contacts, the geometry needs to be regenerated.</span></p></body></html>"))
        self.label_18.setText(_translate("MainWindow", "Current-Controlled Mode"))
        ...
        self.label_6.setText(_translate("MainWindow", "Show Paraview Screenshots"))
        self.pushButton_Show_Paraview_Screenshots.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Check if automatically made screenshots should be displayed (screenshots are saved in Images/). Should not be used in the docker container. </span></p></body></html>"))
        ...
        self.pushButton_Solver_Type.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Choose a solver that will be applied to FEM system of Laplace equation. Correposponding suitable preconditioners are     already defined. The choice is dependent on the stimulation mode, the Laplace formulation (QS or EQS) and the presence of floating conductors.</span></p><p><span style=\" font-size:14pt; font-weight:600;\">Important:</span><span style=\" font-size:14pt;\"> If you are not sure, choose &quot;Default&quot; option.</span></p></body></html>"))
